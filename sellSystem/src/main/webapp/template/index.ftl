...
<div class="g-doc">
    <div class="m-tab m-tab-fw m-tab-simple f-cb">
        <div class="tab">
            <ul>
                ...
                <li <#if !listType?? || listType != "1">class="z-sel"</#if>><a href="${basePath}/">所有内容</a></li>
                <#if user?? && user.usertype == 0><li <#if listType?? && listType == "1">class="z-sel"</#if> ><a href="${basePath}/?type=1">未购买的内容</a></li></#if>
            </ul>
        </div>
    </div>
    ...
    <div class="n-plist">
        ...
        <#else>
            ...
            <#list productList as x>
                <li id="p-${x.id}">
                    <a href="${basePath}/show?id=${x.id}" class="link">
                        <div class="img"><img src="${x.image}" alt="${x.title}"></div>
                        <h3>${x.title}</h3>
                        <div class="price"><span class="v-unit">¥</span><span class="v-value">${x.price}</span></div>
